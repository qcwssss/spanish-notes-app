          ...
          {!isRenaming && !isSubmitting && (
            <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={menuRef}>
                ...
                className="rounded p-1 can-hover:opacity-0 transition-opacity hover:bg-slate-200 focus:opacity-100 can-hover:group-hover:opacity-100 dark:hover:bg-slate-700"
